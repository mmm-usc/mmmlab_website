...
the main steps of a pull request: pull &rarr; edit &rarr; commit with message &rarr; push &rarr; put in a pull request (PR) through the browser. 
...
Navigate to GitHub profile &rarr; Repositories tab &rarr; New &rarr; fill in repository name and click ‘add a README file’ &rarr; Create repository

Navigate to the new repository &rarr; copy the HTTPS or SSH link from under the Code tab &rarr; pull up RStudio (or VSCode) terminal &rarr; clone repository to local machine by typing `<username>$ git clone <URL>`
in the terminal.
