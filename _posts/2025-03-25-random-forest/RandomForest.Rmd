...
::: {.cell-output-display}
![Distribution of response variable: Arithmetic Math Performance](RandomForest_files/figure-html/fig-arith-perf-1.png){#fig-arith-perf width=672}
:::
:::
...
::: {.cell-output-display}
![Distribution of predictors](RandomForest_files/figure-html/fig-predictors-1.png){#fig-predictors fig-pos='h' width=672}
:::
:::
...
::: {.cell-output-display}
![Distribution of predictors against the DV (sum_arith_perf)](RandomForest_files/figure-html/fig-preds_DV-1.png){#fig-preds_DV fig-pos='p' width=672}
:::
:::
