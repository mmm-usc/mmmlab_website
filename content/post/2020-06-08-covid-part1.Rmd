---
title: "Perception of Risks during COVID-19"
author: "Hailin Yue"
date: 2020-06-08T19:57:00-07:00
categories: ["R", "statistics"]
tags: ["covid", "ggplot2", "ethnicity", "visualization"]
output:
  blogdown::html_page:
    toc: true
    number_sections: yes
    includes:
      in_header: toggle_r.html
---
...
Analyze Covid-19 survey data collected by USC on March, 2020.
...
gender_finance <- demo %>% # Plot perceived risk of running out of money
  select(gender, cr009) %>%
...
* Respondents in New York, Pennsylvania, and Michigan report a lower perceived financial risk related to Coronavirus.
* While respondents in California, Illinois, and Texas report a higher perceived unemployment risk and financial risk related to Coronavirus.
...
finance_state_stat <- finance_state_stat[, c("statereside", "length", "mean", "sd")] %>%
  arrange(-mean) # sort by mean in descending order
...
* Respondents with a lower education degree report a higher perceived unemployment risk and financial risk.

```{r education}
demo <- demo %>% # recode education level into more organized groups
